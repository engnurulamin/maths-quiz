...
<div class="control mx-5 my-4">
	<div class="field">
		<div class="columns">
			...
			>
				<div
					class="card py-1 has-background-info-dark {$difficulty === 'easy'
						? 'selected'
						: ''} card-shadow"
				>
			...
			>
				<div
					class="card py-1 has-background-primary-dark {$difficulty === 'medium'
						? 'selected'
						: ''} card-shadow"
				>
			...
			>
				<div
					class="card py-1 has-background-danger-dark {$difficulty === 'hard'
						? 'selected'
						: ''} card-shadow"
				>
